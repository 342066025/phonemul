...
export const PhoneSim_Config = {
    ...
    STORAGE_KEY_CHARACTER_LIST: 'phone-sim-character-list-v10-0',
    ...
    INITIAL_LOREBOOK_ENTRIES: [
        ...
        { name: '手机模拟器_角色映射', content: '{}', enabled: false, comment: 'Managed by Phone Simulator Plugin. Do not edit manually.' },
    ]
};